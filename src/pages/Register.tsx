...
import { UserPlus, Mail, Lock, User, Phone, AlertCircle, Heart } from 'lucide-react';
            ...
            <div className="max-w-md w-full space-y-8 relative z-10 glass-effect p-8 rounded-3xl border border-white/10 shadow-2xl">
                ...
                <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                        ...
                        <Link to="/login" className="text-sm font-semibold text-teal-400 hover:text-teal-300 transition-colors">
                            Sign in
                        </Link>
                    </div>
                </form>
